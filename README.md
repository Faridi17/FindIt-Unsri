...
FounditUnsri is a platform that provides information about items found within the Sriwijaya University (Unsri) environment. This website aims to facilitate the handover of found items to the faculty administration, who will then upload the information to help return the items to their rightful owners.
...
4.  **Create the MySQL database:**
    ...
    ```sql
    CREATE DATABASE foundit_unsri;
    ```

5.  **Create the `users` and `item` tables:**
